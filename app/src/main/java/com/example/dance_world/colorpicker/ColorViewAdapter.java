package com.example.dance_world.colorpicker;
...
public class ColorViewAdapter extends RecyclerView.Adapter<ColorViewAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements OnClickListener {
        ...
        public ViewHolder(View v) {
            super(v);
            //buttons settings
            colorItem = v.findViewById(com.example.dance_world.R.id.color);
            ...
            LinearLayout linearLayout = v.findViewById(com.example.dance_world.R.id.linearLayout);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(com.example.dance_world.R.layout.palette_item, parent, false);
